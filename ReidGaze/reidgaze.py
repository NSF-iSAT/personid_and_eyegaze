...
def processRequest (params):
    ...
    for t in range(startTime, endTime,testratesec):
        ...
        image.save(f"/scratch/shared/whitehill/recording_id_6425d1ae29b832001e054b16/img5_{t}.jpg")
        img_list.append(image)
    with open(f"/scratch/shared/whitehill/recording_id_6425d1ae29b832001e054b16/example_all4.json","w",encoding='utf-8') as f:
...
def get_ref_emb(registrition,ref_duration):
    ...
    for one_ref in registrition:
        ...
        for t in range(0,length,ref_duration):           
            ...
            ref_image.save(f"/scratch/shared/whitehill/recording_id_6425d1ae29b832001e054b16/0exam_{label}_{t}.jpg")
